...
?>
  ...
  <!-- Forms -->
  <form  action="registerScript.php" method="post" onsubmit="return validate();">
	...
	Repeat Password: <input type="password" name="rpt-password" id="rpt-password"><p>
	<input type="submit">
	<br><br><a href="loginpage.php">Already got an account? Click here.</a>
	</div>
    </div>
</form>
...
<script>
  function validate() {
    ...
    var value = document.getElementById('password').value;
    if (value != document.getElementById('rpt-password').value) {
