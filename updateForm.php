...
<br><h1>Update Details</h1>
<p> If you wish to enter a new username and password.</p>
<form action="update.php" method="post">ID: <input type="text" name="id" value=<?php echo $row["ID"]; ?> readonly><p> 
