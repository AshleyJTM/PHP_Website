...
echo "<br><div style='text-align:center; border: 5px outset black; background-color: white; width:600px; margin:0 auto;'>".
	"<br><h1>Admin Account Details</h1>".
	"<p> Change usernames, passwords and levels.</p>";
	...
	while ($row=mysqli_fetch_assoc($result))
{
	...
	"<br>Level: " . $row["level"] .
	"<br><a href=updateFormAdmin.php?ID=" . $row["ID"] . ">Update</a>"  .
	"<br><a href=deleteAdmin.php?ID=" . $row["ID"] . "&username=" . $row["username"] . ">Delete</a>"  .
	"</p>" .
	"<br>";
